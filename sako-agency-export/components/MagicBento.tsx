...
const DEFAULT_GLOW_COLOR = "201, 168, 76"; // Sako Gold
...
const ParticleCard = ({
  ...
  return (
    <div
      ref={cardRef}
      className={`${className} bento-particle-container`}
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor: card.color || "var(--bento-bg)",
            ...
            return (
              ...
              >
                <div className="magic-bento-card__header">
                  ...
                  {card.icon && <div className="magic-bento-card__icon" style={{ color: "var(--gold)", opacity: 0.8 }}>{card.icon}</div>}
                </div>
